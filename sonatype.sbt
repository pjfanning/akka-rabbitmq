pomExtra in Global := {
  <scm>
    <connection>scm:git:git@github.com:pjfanning/akka-rabbitmq.git</connection>
    <developerConnection>scm:git:git@github.com:pjfanning/akka-rabbitmq.git</developerConnection>
    <url>git@github.com:pjfanning/akka-rabbitmq.git</url>
  </scm>
  <developers>
    <developer>
      <id>sbmpost</id>
